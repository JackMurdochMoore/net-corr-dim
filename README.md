...
_load_network.m:_ Load a empirical network from data in folder "networks".\
...
_show_fit_func.m:_ Fit power-law to an interval and illustrate fit and objective function (negative log-likelihood per observation) in figures.\
